...
<h4> Team "SAETI" (SETI + SAI) </h4>
 ...
 - 날짜 : 2019. 11. 27
 - 주제 : 세종인의 얼굴이 만드는 모자이크 설치예술 - who makes sejong
 - 단순한 참가자 : 이장후, 배현진, 나영채, 이하리리, 김기홍, 임수현
...
### (8) 데이터야놀자 2022 발표
<h4> Team "플랭크현동", <엎드려뻗친 친구를 피규어로 만들어버렸다> </h4>

- 날짜 : 2022.10
- 주제 : 사진측량(Photogrammetry) 스터디
- 참가자 : 이장후, 조용재, 장수명, 이현동, 장수명
- [프로젝트 깃허브](https://github.com/ProtossDragoon/PlankHyundong), [발표 유튜브](TODO)

<br>

### (9) 2023,『올담』 데이터 활용 시각화 경진대회 우수상

- 날짜 : 2023.04
- 주제 : 충청남도 소방 안전 실태와 화재 발생 및 피해 현황 분석
- 참가자 : 서상민
- [프로젝트 깃허브](https://github.com/ss721229/alldam)

<br>

### (10) 세종대 2023-1 전공심화공동체 3등

<h4> Team 70.0 </h4>

- 날짜 : 2023.08
- 주제 : 인공지능 경진대회 플랫폼인 ‘Kaggle’을 활용해 총 3개의 대회 참가 및 실무 능력 향상
- 참가자 : 서민정, 서상민, 최락원

<br>

### (11) 세종대 2023-2 전공심화공동체 1등
...
### (14) 세종대학교 2023 우수 동아리
<h4> SAI </h4>

- 날짜 : 2023.11
- 참가자 : 김이나, 서민정, 강산들, 최락원, 이준민, 심민경, 서상민, 전형서


<br>

### (15) Microsoft AI Challenge for Bio Diversity 장려상
